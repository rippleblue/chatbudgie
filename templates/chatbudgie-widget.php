...
<div class="chatbudgie-widget" role="dialog" aria-label="ChatBudgie chat window">
    <div class="chatbudgie-toggle">
        <img src="<?php echo $avatar_url; ?>" alt="ChatBudgie avatar">
    </div>
    <!-- Header -->
    <header class="chatbudgie-header">
        ...
        <button class="chatbudgie-header__close" aria-label="Close chat">
    ...
    <!-- Messages -->
    <main class="chatbudgie-messages" id="chatMessages">
...
<!-- Error banner -->
<div class="chatbudgie-error-banner" role="alert">
    ...
    <button class="chatbudgie-retry-btn" type="button" aria-label="Try again">
...
<!-- Input -->
<form class="chatbudgie-input" id="chatForm" autocomplete="off">
    <input
        type="text"
        id="chatInputField"
    ...
    <button type="submit" class="chatbudgie-input__send" aria-label="Send message">
        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#3F7CF5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M22 2 11 13" />
            <path d="M22 2 15 22 11 13 2 9 22 2z" />
        </svg>
    </button>
    <button type="button" class="chatbudgie-input__stop" aria-label="Stop response" hidden>
